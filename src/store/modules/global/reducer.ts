...
export const defaultState: GlobalStateType = {
  count: 1,
    currentNav:0,
    navs:[{text:'首页',id:1,path:'/'},{text:'课程',id:2,path:'/course'},{text:'地图',id:3,path:'/map'},{text:'项目管理',id:4,path:'/project'}],
    commonChannels:[{icon:'/person.png',title:'通用聊天频道',id:1},
        {title:'自定义聊天频道1',id:2},{title:'自定义聊天频道2',id:3},
        {title:'自定义聊天频道3',id:4}
        ],
    currentChannel:0,
    projects:[{name:'1',id:1,title:'项目提交Offer'},
    ...
    currentPannel:0,
    pannels:[{text:'阶段子任务',id:1},{id:2,text:'房产投资计算器'}]
};
const { addCount,setCurrentnav ,setPannel} = actions;
