                    ...
                    <Grid item  key={index}>
                        ...
                        <Box css={styles.topBox}>
                            ...
                            <Box css={styles.profileBox}>
                                ...
                                <InputBase css={styles.profileInput} multiline placeholder={'这是一句个人简介'} />
                            </Box>
                            {
                                item.isFriend ? <IconButton css={styles.topRightBtn}><Image css={styles.checkIcon} src={checkIcon} alt={''}/></IconButton>
                                    :<IconButton css={styles.topRightBtn}><Image css={styles.addIcon} src={addIcon} alt={''}/></IconButton>
                            }

                        </Box>
                            <Box css={styles.bottomBox}>
                                {item.tags.map((item:any,index:number)=>(
                                    <Box css={styles.tagText} key={index}>{item}</Box>
                                ))}
                            </Box>
                        </Box>
                    </Grid>
