...
const Section1: React.FC<ISection1> = () => {
  return (
    <Box css={styles.container}>
      <Image css={styles.bg} width={1920} height={825} src={"/section1.webp"} alt={""} />
...
<WhiteButton css={styles.whiteBtn} variant="contained">开启投资之旅</WhiteButton>
            <BlackButton css={styles.blackBtn} variant="contained">点击观看视频</BlackButton>
        </Box>
    </Box>
  );
};
