...
const Sider=props=>{
    ...
    return (
        <List component={'nav'} className={classes.sider}>
            <ListItem onClick={handleClick.bind(null,0)} className={clsx(classes.serviceBtn,{[classes.active]:idx==0})} button>Services</ListItem>
            <ListItem button onClick={handleClick.bind(null,1)} className={clsx(classes.serviceBtn,{[classes.active]:idx==1})}>Technologies</ListItem>
            <Collapse in={idx==1} timeout="auto" unmountOnExit>
                <List disablePadding>
                    <ListItem className={classes.nested} button onClick={handleClickPl}><ListItemText>Programming Languages</ListItemText>{plOpen ? <ExpandLess /> : <ExpandMore />}</ListItem>
            ...
            <ListItem button onClick={handleClick.bind(null,2)} className={clsx(classes.serviceBtn,{[classes.active]:idx==2})}>Solutions</ListItem>
            <ListItem button onClick={handleClick.bind(null,3)} className={clsx(classes.serviceBtn,{[classes.active]:idx==3})}>Blog & News</ListItem>
